...
export type Job = { id: number; name: string; data_source_id: number; schedule_type: string; cron: string; interval_minutes?: number; schemas: string[]; collect_storage: boolean; is_active: boolean; next_run_at?: string; created_at: string }
